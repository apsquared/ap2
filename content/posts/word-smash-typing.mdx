...
![Word Smash Typing Game](/wordsmash.png)
...
Overall, I was amazed how much stuff AI got write.  The more I used it the more my prompts got better.  I recommend you be as detailed as possible.  Also create new windows when you change the task at hand, it(Cursor) sometimes got confused when switching tasks.

## Typing Maniac Clone

The old Flash game Typing Maniac is the inspiration for this game, although Typing Maniac was a lot more colorful.  If anyone has any other Typing Maniac or other typing game features you want reach out to me on X and I'll try to vibe code it further.

[Typing Maniac Clone](https://wordsmash.apsquared.co)
